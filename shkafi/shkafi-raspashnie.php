...
?>
  ...
  <body>
    ...
    <div class="nav">
      ...
      <div class="btn">
        <div class="dropdown">
          ...
          <div class="dropdown-content">
            <a href="shkafi-kupe.php">Шкафы-купе</a>
            <a href="shkafi-raspashnie.php">Распашные</a>
            <a href="shkafi-uglovie.php">С зеркалом</a>
          </div>
        </div>
      </div>
      <div class="btn">
    ...
    <hr>
    <div class="best_text">Шкафы распашые</div>
    <div class="best">
      <?php $sql = "SELECT * FROM products WHERE sub_category='shkaf-raspashnoy' ORDER BY rand()"; ?>
      <?php if ($result = $link->query($sql)) : ?>
        <?php foreach ($result as $row) : ?>
          <div class='image'>
            <img style="object-fit: cover; height: 100px; width: auto;" src="../image/products/shkafi/<?= $row['img'] ?>"></br>
            <a><?= $row['title'] ?></a>
