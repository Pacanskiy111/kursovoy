...
?>
  ...
  <body>
    ...
    <div class="nav">
      ...
      <div class="btn">
        <div class="dropdown">
          ...
          <div class="dropdown-content">
            <a href="krovati-dvuspalnie.php">Двуспальные</a>
            <a href="krovati-odnospalnie.php">Односпальные</a>
          </div>
        </div>
      </div>
      <div class="btn">
    ...
    <hr>
    <div class="best_text">Кровати-односпальные</div>
    <div class="best">
            <?php $sql = "SELECT * FROM products WHERE sub_category='krovat-odnospalniy' ORDER BY rand()"; ?>
            <?php if ($result = $link->query($sql)) : ?>
                <?php foreach ($result as $row) : ?>
                    <div class='image'>
                        <img style="object-fit: cover; height: 100px; width: auto;" src="../image/products/krovati/<?= $row['img'] ?>"></br>
                        <a><?= $row['title'] ?></a>
