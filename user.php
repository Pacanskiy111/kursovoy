...
<body>
<div class="header">
<div class="logo"><a href="index.php"><img src="image/logo.png" width="250" height="45"></a></div>
<div class="src">
...
?>
 ...
 <a href="index.php" class="button button-green" style="font-family: Century Gothic;background-color: #ffffff;padding: 0px;font-size: 20px;border: none;color: grey;font-weight:bold;">Выход</a>
    </form>
    </div>
</div>
</div>
...
?>
    <form action="exit.php" method="post">
<li class="mobile-menu__item"><a href="index.php" class="mobile-menu__link">Выход</a></li>
    </form>
    </div>
<div class="nav2">
<div class="btn">
