...
?>
    ...
    <body>
        ...
        <hr>
        <div class="best_text">Стенки</div>
        <div class="best">
            <?php $sql = "SELECT * FROM products WHERE category='stenka' ORDER BY rand()"; ?>
            <?php if ($result = $link->query($sql)) : ?>
                <?php foreach ($result as $row) : ?>
                    <div class='image'>
                        <img style="object-fit: cover; height: 100px; width: auto;" src="../image/products/stenki/<?= $row['img'] ?>"></br>
                        <a><?= $row['title'] ?></a>
